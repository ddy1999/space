...
let SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function update() {
      let month = arguments.length <= 0 || arguments[0] === undefined ? this.tmonth : arguments[0];
      let year = arguments.length <= 1 || arguments[1] === undefined ? this.tyear : arguments[1];
    ...
    value: function updateSize() {
      let width = arguments.length <= 0 || arguments[0] === undefined ? this._options.width : arguments[0];
      let height = arguments.length <= 1 || arguments[1] === undefined ? this._options.height : arguments[1];
